...
| [CONSOLIDATION.md](./CONSOLIDATION.md) | RecruitAI → OpsAI merge log (2026-07-06) |
| [DEPLOY-STATUS.md](./DEPLOY-STATUS.md) | OpsAI deploy checklist |
| [audience-pitches/](./audience-pitches/) | Recruiter / founder / client pitches for OpsAI |
...
| Priority | Action |
|----------|--------|
| 1 | ~~Deploy OpsAI~~ **Done** — record Loom next |
| 2 | Record 2–3min OpsAI Loom demo (support + recruitment) |
